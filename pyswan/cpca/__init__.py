...
"""
github from: https://github.com/DQinYuan/chinese_province_city_area_mapper
...
# 结果 dataframe 的列名
_PROVINCE = "province"
_PROVINCE_POS = "province_pos"

_CITY = "city"
_CITY_POS = "city_pos"

_COUNTY = "area"
_COUNTY_POS = "area_pos"
...
def _init_data(stop_key="([省市]|特别行政区|自治区)$") -> (dict, Matcher):
    ...
    with resource_stream('pyswan.cpca.resources', 'adcodes.csv') as csv_stream:
